 ...
 * @Description:     公共设施报修
 * @Version:         1.0.0
 * @author:          lihb(765029455@qq.com)
 * @date             2017.4.15
 * ==NOTES:=============================================
 * v1.0.0(2017.4.15):
 初始生成
 * ------------------------------------------------------------*/
angular.module('sunApp').controller('publicMaintainCtrl', function($scope, $rootScope, $httpParamSerializer, $http, $state, fileReader){
    //头部title
    $rootScope.pageTitle = "公共设施报修";
    ...
    $scope.submit = function(){ 
        ...
        //表单正常提交
        if($scope.publicMaintainForm.$valid){
            var formData = {
            ...
            $http({
                ...
                url: api_Data.MainTain.submitPublic,
                headers:{        
